...
typedef struct qs_cachectrl_s {
   ...
   void _std (*setsize)(u32t size_mb);
   ...
   u32t _std (*setsize_str)(const char *size);
   ...
   void _std (*setprio)(u32t disk, u64t start, u32t size, int on);
   ...
   u32t _std (*stat)(u32t disk, u32t *pblocks);

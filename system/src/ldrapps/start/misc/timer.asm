...
_BSS            segment dword public USE32 'BSS'
                ...
                extrn   ZeroAddress:dword                       ; phys 0 address
...
@@vbeep_nosound:
                ...
                pop     eax                                     ;
                mov     esi,ZeroAddress                         ; update sound
                add     eax,[esi+BIOS_TICS]                     ; end time
                mov     _NextBeepEnd,eax                        ;
                popf                                            ;
@@vbeep_end:
                pop     esi                                     ;
@@vbeep_exit:
...
_tm_getdate     proc    near                                    ;
                mov     edx,ZeroAddress                         ;
                mov     edx,[edx+BIOS_TICS]                     ; update cmos time
                lea     eax,[edx-17]                            ; a least once per
